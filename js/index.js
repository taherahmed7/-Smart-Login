...
//     userValidation();
//     accountExist();
//     if (userValidation() == true && accountExist() == false) {
//         let user = {
...
//         let confirmingMsg = document.getElementById('confirmingMsg');
//         confirmingMsg.classList.replace("d-none", "d-block");
...
//     if (userValidation() == true && userEmailValidation() == true && userPasswordValidation() == true) {
//         return true;
//     } else {
//         return false;
//     }
...
//         if (users[i].name.toUpperCase() == userNameInput.value.toUpperCase() || users[i].mail.toUpperCase() == userEmailInput.value.toUpperCase()) {
...
//     for (var i = 0; i < users.length; i++) {
//         if (users[i].mail.toUpperCase() == loginEmail.value.toUpperCase() && users[i].password.toUpperCase() == loginPassword.value.toUpperCase()) {
